...
```{r}
### EXPLORE HERE ###
# Make list of dataset names to cycle through.
interested_data <- list(steam_games, flow_sample, vancouver_trees, apt_buildings)
# Names of datasets in string form to print later. 
name_strings <- list("steam_games", "flow_sample", "vancouver_trees", "apt_buildings")

# Prints out the summary of attributes for each dataset. Can summarize more datasets in the future by adding to the interested_data and name_strings.
n <- 1
for (var in interested_data){
  # Indicate which dataset is being summarized.
  message("dataset = ", name_strings[n])
...
Does the community perception of how good a game is affect how much a game's price is discounted?
